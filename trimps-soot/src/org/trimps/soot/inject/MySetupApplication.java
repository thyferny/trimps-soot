 ...
 * Bodden, and others.
 ******************************************************************************/
package org.trimps.soot.inject;
...
public class MySetupApplication {
	...
	public InfoflowResults runInfoflow(ResultsAvailableHandler onResultsAvailable){
		...
		MyInfoflow info;
		if (cfgFactory == null)
			info = new MyInfoflow(androidJar, forceAndroidJar);
		else
			info = new MyInfoflow(androidJar, forceAndroidJar, cfgFactory, new DefaultPathBuilderFactory());
